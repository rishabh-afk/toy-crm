...
const Profile = () => {
  ...
  return (
    <div className="group relative">
      ...
      <div className="opacity-0 hidden group-hover:block group-hover:opacity-100 bg-whiteBg shadow-md border absolute right-0 rounded-xl">
        ...
        <div className="overflow-hidden">
          <p
            onClick={logout}
            className="flex hover:bg-infobg hover:rounded-b-xl cursor-pointer items-center border-t p-4 gap-2"
          >
