  ...
  return (
    <div className="">
      <div className="flex justify-between items-center mb-2 -mt-5">
        <div>
          <p className="text-lg text-primary font-semibold">Select Product</p>
        </div>
        {/* <button
          type="button"
          onClick={addItem}
      ...
      <div className="overflow-x-auto">
        <table className="table-auto relative border-collapse whitespace-nowrap border border-gray-300">
          <thead>
