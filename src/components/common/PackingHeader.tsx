...
const PackingHeader = ({ data }: { data: any }) => {
  const fields = [
    { label: "Customer Name", value: data?.customerName },
    { label: "Packed By", value: data?.packedByName },
  ];
  return (
    <>
      <div className="grid grid-cols-2 mt-2 bg-green-500 text-white p-4 rounded-lg justify-between items-center gap-10 border-b pb-4 mb-4">
